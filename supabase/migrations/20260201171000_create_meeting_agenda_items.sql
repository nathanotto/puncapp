...
CREATE POLICY IF NOT EXISTS "Users can view agenda items in their chapters" ON meeting_agenda_items
  FOR SELECT USING (
    meeting_id IN (
...
CREATE POLICY IF NOT EXISTS "Authenticated users can manage agenda items" ON meeting_agenda_items
